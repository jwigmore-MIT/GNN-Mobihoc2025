...
if __name__ == "__main__":
    create_context_set(
        100,
        name="power_util_context_100_set_a",
        ...
        service_rate_sampler=lambda: np.random.randint(3, 8),
        link_power_sampler=lambda: np.random.randint(1, 3),
        arrival_rate_sampler=lambda: np.random.gamma(0.5, 0.5),
