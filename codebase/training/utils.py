...
from experiments.GNNBiasedBackpressureDevelopment.env_creation.utils import compute_metric_stats
...
if __name__ == "__main__":
    context_set_dir = os.path.join(PROJECT_DIR,"experiments\\GNNBiasedBackpressureDevelopment\\context_sets\\barabasi_albert_20_context_set_3_19b")
    run_dir = os.path.join(PROJECT_DIR, "experiments\\GNNBiasedBackpressureDevelopment\\runs\\run1")
    training_contexts_dir, test_contexts_dir = create_training_and_test_contexts(context_set_dir, run_dir, num_training_contexts=5)
    print(training_contexts_dir)
    print(test_contexts_dir)
    print(os.listdir(training_contexts_dir))
    print(os.listdir(test_contexts_dir))
